                ...
                <div className="col-lg-8">
                    <div className="card mt-4">
                        <div className="card-body">
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col ml-n2 px-0 px-sm-2">
                                        ...
                                        <p className="card-text small text-muted">
                                            <span className="fe fe-clock"></span> <time
                                            >4hr ago</time>
                                        </p>
                            ...
                            <p className="mb-4">
                                What do you y'all think? Would love some feedback from <Link to="/profile"
                                    className="badge badge-soft-primary">@Ab</Link>
                                or <Link to="/profile" className="badge badge-soft-primary">@Adolfo</Link>?
                                                </p>
                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <Link to="/profile" className="btn btn-sm btn-white">
                                            <i className="far fa-frown-open"></i> 1
                                                            </Link>
                                        <Link to="/profile" className="btn btn-sm btn-white">
                                            <i className="far fa-grin"></i> 2
                                                            </Link>
                                    ...
                                    <div className="col ml-n2">
                                        ...
                                        <div className="comment-body">
                                            ...
                                            <p className="comment-text">
                                                ...
                                                left, but it feels like a lot to process
                                                                    and doesn't really <em>show</em> me what the product
